...
import com.example.filmes.filmesHome.FilmesServices
...
class FilmeViewModel : ViewModel() {
    ...
    private val filmesService = retrofit.create(FilmesServices::class.java)                          //Chama Serviço para API .themoviedb
