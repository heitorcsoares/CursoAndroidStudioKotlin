...
import com.example.filmes.FilmeItemListener
import com.example.filmes.MyFilmeRecyclerViewAdapter
...
class FilmeItemFragment : Fragment(), FilmeItemListener {
    ...
    private fun initObservers() {
        ...
        viewModel.navigationToDetalhesLiveData.observe(viewLifecycleOwner, Observer {
            val action = FilmeItemFragmentDirections.actionFilmeItemFragmentToFilmesDetalhesFragment3()
